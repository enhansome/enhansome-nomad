...
* [gerrowadat/nomad-gitops](https://github.com/gerrowadat/nomad-gitops) ⭐ 1 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - Another implementation of 'gitops' style drift detection and deployment for Nomad.
...
* [perrymanuk/hashi-homelab](https://github.com/perrymanuk/hashi-homelab) ⭐ 363 | 🐛 8 | 🌐 HCL | 📅 2026-09-10 Job files for a small lightweight homelab based on nomad and consul from hashicorp.
...
* [hashicorp/nomad-pack](https://github.com/hashicorp/nomad-pack) ⭐ 446 | 🐛 60 | 🌐 Go | 📅 2026-09-11 - An official templating tool and package manager for Nomad, currently a Tech Preview.
