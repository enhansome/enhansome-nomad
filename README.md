...
* [hashicorp/nomad-autoscaler](https://github.com/hashicorp/nomad-autoscaler/) ⭐ 477 | 🐛 75 | 🌐 Go | 📅 2026-09-04 - HashiCorp's official Nomad Autoscaler. Supports scaling allocations within Nomad and scaling nodes on AWS, Azure, GCP, or arbitrary infrastructure via plugins.
...
* [hashicorp/nomad-pack](https://github.com/hashicorp/nomad-pack) ⭐ 446 | 🐛 61 | 🌐 Go | 📅 2026-09-05 - An official templating tool and package manager for Nomad, currently a Tech Preview.
