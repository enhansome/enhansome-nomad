...
* [hashicorp/damon](https://github.com/hashicorp/damon) ⭐ 486 | 🐛 10 | 🌐 Go | 📅 2026-08-24 - An early stage terminal dashboard for Nomad.
* [robinovitch61/wander](https://github.com/robinovitch61/wander) ⭐ 480 | 🐛 4 | 🌐 Go | 📅 2024-06-18 - A terminal UI for Nomad.

## Autoscaling

* [hashicorp/nomad-autoscaler](https://github.com/hashicorp/nomad-autoscaler/) ⭐ 477 | 🐛 79 | 🌐 Go | 📅 2026-08-31 - HashiCorp's official Nomad Autoscaler. Supports scaling allocations within Nomad and scaling nodes on AWS, Azure, GCP, or arbitrary infrastructure via plugins.
...
* [gerrowadat/nomad-gitops](https://github.com/gerrowadat/nomad-gitops) ⭐ 1 | 🐛 1 | 🌐 Go | 📅 2026-08-26 - Another implementation of 'gitops' style drift detection and deployment for Nomad.
...
* [sevensolutions/nomad-iis](https://github.com/sevensolutions/nomad-iis) ⭐ 26 | 🐛 6 | 🌐 C# | 📅 2026-08-24 - A nomad task driver to run [windows IIS](https://www.iis.net/) tasks.
...
* [perrymanuk/hashi-homelab](https://github.com/perrymanuk/hashi-homelab) ⭐ 363 | 🐛 8 | 🌐 HCL | 📅 2026-08-30 Job files for a small lightweight homelab based on nomad and consul from hashicorp.
...
* [hashicorp/nomad-pack](https://github.com/hashicorp/nomad-pack) ⭐ 446 | 🐛 60 | 🌐 Go | 📅 2026-08-31 - An official templating tool and package manager for Nomad, currently a Tech Preview.
* [ngine-io/chaotic](https://github.com/ngine-io/chaotic) ⭐ 74 | 🐛 3 | 🌐 Python | 📅 2026-08-30 - Chaos monkey with integrated nomad support. Runs as batch job or service and kills allocations periodically and randomly.
...
* [prabirshrestha/synology-nomad](https://github.com/prabirshrestha/synology-nomad) ⭐ 30 | 🐛 3 | 🌐 Shell | 📅 2026-08-13 - HashiCorp Nomad Package for Synology DSM 7+. Includes client and server.
