...
* [hashicorp/nomad-autoscaler](https://github.com/hashicorp/nomad-autoscaler/) ⭐ 477 | 🐛 79 | 🌐 Go | 📅 2026-09-01 - HashiCorp's official Nomad Autoscaler. Supports scaling allocations within Nomad and scaling nodes on AWS, Azure, GCP, or arbitrary infrastructure via plugins.
...
* [gerrowadat/nomad-gitops](https://github.com/gerrowadat/nomad-gitops) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - Another implementation of 'gitops' style drift detection and deployment for Nomad.
...
* [perrymanuk/hashi-homelab](https://github.com/perrymanuk/hashi-homelab) ⭐ 363 | 🐛 8 | 🌐 HCL | 📅 2026-08-31 Job files for a small lightweight homelab based on nomad and consul from hashicorp.
...
* [hashicorp/nomad-pack](https://github.com/hashicorp/nomad-pack) ⭐ 446 | 🐛 60 | 🌐 Go | 📅 2026-09-01 - An official templating tool and package manager for Nomad, currently a Tech Preview.
