...
* [perrymanuk/hashi-homelab](https://github.com/perrymanuk/hashi-homelab) ⭐ 363 | 🐛 8 | 🌐 HCL | 📅 2026-09-08 Job files for a small lightweight homelab based on nomad and consul from hashicorp.
...
* [hashicorp/nomad-pack](https://github.com/hashicorp/nomad-pack) ⭐ 446 | 🐛 61 | 🌐 Go | 📅 2026-09-08 - An official templating tool and package manager for Nomad, currently a Tech Preview.
