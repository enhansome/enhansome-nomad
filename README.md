...
* [gerrowadat/nomad-gitops](https://github.com/gerrowadat/nomad-gitops) ⭐ 2 | 🐛 1 | 🌐 Go | 📅 2026-09-16 - Another implementation of 'gitops' style drift detection and deployment for Nomad.
...
* [perrymanuk/hashi-homelab](https://github.com/perrymanuk/hashi-homelab) ⭐ 364 | 🐛 8 | 🌐 HCL | 📅 2026-09-26 Job files for a small lightweight homelab based on nomad and consul from hashicorp.
...
* [hashicorp/nomad-pack](https://github.com/hashicorp/nomad-pack) ⭐ 444 | 🐛 59 | 🌐 Go | 📅 2026-09-26 - An official templating tool and package manager for Nomad, currently a Tech Preview.
